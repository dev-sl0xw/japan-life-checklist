...
- **거주 지역 선택**: 도도부현(47) 선택 시 대형쓰레기·役所 등 지역별 공식 링크가 반영됩니다(기본 도쿄도, 미등록 지역은 전국 공통 안내로 폴백)
...
**v1.5+ (예정)**: 한국 세무·외환·영사관·병역·해외재산조서, 영구귀국, 자녀학교 상세, 펫, 자가매각, **지역팩 구/시 단위 확장**(현재는 도도부현 단위·도쿄도 데이터), 한↔일 언어 토글, PWA.
